...
//         engine.load("file:///C:/Users/tower/OneDrive/Desktop/Fast-Nu/4th%20Semester/4.%20SDA/Project/testjavafx/firstjavafx/src/map.html");
...
public class mainSceneController {
    ...
    @FXML public Rectangle searchbuttonrect;
    @FXML public Rectangle map;
    @FXML public Rectangle humidityRect;
    @FXML public Rectangle forcastRect;
    @FXML public Rectangle searchRect;
    @FXML public Rectangle riseRect;
    @FXML public Rectangle setRect;
    @FXML public Region maxminRect;
    @FXML public Region weatherRect;
    @FXML public Region stampRect;
    @FXML public Rectangle dayRect;
    @FXML public Button gasesButton;
    @FXML public Group gasesTable;  
    @FXML public AnchorPane container;
    @FXML public Line headerLine;
    @FXML public Button searchButton;

    @FXML public ImageView backGroundPic;  
    @FXML public TextField textfieldLocation;

    @FXML public Label mintxt;  
    @FXML public Label maxtxt;
    @FXML public Label searchtxt;

    @FXML public Label locationLabel;
    @FXML public Label temperatureLabel;
    @FXML public Label time;

    @FXML public Label sunRisetxt;
    @FXML public Label sunSettxt;
    @FXML public Label forecasttxt; 
    @FXML public Label datetxt; 
    @FXML public Label humiditytxt;

    
    @FXML public Label feelLabel;
    @FXML public Label minmaxtxt;

    // 3 hourly stamp temprature
    @FXML public Label h3_temp1;
    @FXML public Label h3_temp2;
    @FXML public Label h3_temp3;
    @FXML public Label h3_temp4;
    @FXML public Label h3_temp5;
    @FXML public Label h3_temp6;
    @FXML public Label h3_temp7;
    @FXML public Label h3_temp8;

    @FXML public Label[] h3_tempLabels;

    // 3 hourly stamp time
    @FXML public Label h3_time1;
    @FXML public Label h3_time2;
    @FXML public Label h3_time3;
    @FXML public Label h3_time4;
    @FXML public Label h3_time5;
    @FXML public Label h3_time6;
    @FXML public Label h3_time7;
    @FXML public Label h3_time8;

    @FXML public Label[] h3_timeLabels;

    //time stamp circles
    @FXML public Circle c1;
    @FXML public Circle c2;
    @FXML public Circle c3;
    @FXML public Circle c4;
    @FXML public Circle c5;
    @FXML public Circle c6;
    @FXML public Circle c7;
    @FXML public Circle c8;

    public Circle[] circles;

    @FXML public Line stampline;
    @FXML public ImageView weatherIcon;
    @FXML public ImageView humidityIcon;  
    @FXML public ImageView minmaxIcon;  
    @FXML public ImageView sunriseIcon;  
    @FXML public ImageView sunsetIcon;
    @FXML public ImageView locationIcon;
    @FXML public ImageView gasesIcon;
    @FXML public Label weatherDes;
    @FXML public Label fivedaytxt;

    @FXML public Label f_date1;
    @FXML public Label f_date2;
    @FXML public Label f_date3;
    @FXML public Label f_date4;
    @FXML public Label f_date5;
    @FXML public Label f_max1;
    @FXML public Label f_max2;
    @FXML public Label f_max3;
    @FXML public Label f_max4;
    @FXML public Label f_max5;
    @FXML public Label f_min1;
    @FXML public Label f_min2;
    @FXML public Label f_min3;
    @FXML public Label f_min4;
    @FXML public Label f_min5;

    Label[] f_dateLabels;
    Label[] f_maxLabels;
    Label[] f_minLabels;

    @FXML public Rectangle pollutingRect;
    @FXML public CubicCurve triRect;

    @FXML public Label air_d1;
    @FXML public Label air_d2;
    @FXML public Label air_d3;
    @FXML public Label air_d4;
    @FXML public Label air_d5;
    @FXML public Label air_d6;
    @FXML public Label air_d7;
    @FXML public Label air_d8;
    @FXML public Label air_p1;
    @FXML public Label air_p2;
    @FXML public Label air_p3;
    @FXML public Label air_p4;
    @FXML public Label air_p5;
    @FXML public Label air_p6;
    @FXML public Label air_p7;
    @FXML public Label air_p8;
    @FXML public Label aqi_data;
    @FXML public Label aqi_label;

    Label[] airLabels;

    @FXML public Label pollutinggastxt;
    @FXML public Label ctxt;
    @FXML public Label ftxt;

    @FXML public ImageView coIcon;

    @FXML public Rectangle FCrect;
    @FXML public Rectangle FCrect1;
    @FXML public Rectangle unitrect;
    @FXML public Rectangle unitrect1;
    @FXML public Button unitbutton;
    ...
    public int generateTestingTemperature() {
    ...
    public void changeRectangleColorToBlack()
    {
        ...
        weatherRect.setStyle("-fx-background-color: rgba(0, 0, 0, 0.6)" +"-fx-background-radius: 0 10 10 0;");
    ...
    void changeUnit(ActionEvent event){
        ...
        if(flag){
            ...
            feelLabel.setText(fahrenheitToCelsius(getIntegerFromString(feelLabel))+"°");
            minmaxtxt.setText((fahrenheitToCelsius(getIntegerFromString(minmaxtxt))) + "°");
        }
        else{
            ...
            minmaxtxt.setText((celsiusToFahrenheit(getIntegerFromString(minmaxtxt))) + "°");
            feelLabel.setText((celsiusToFahrenheit(getIntegerFromString(feelLabel))) + "°");
        }
    ...
    {
        return Integer.parseInt(temp.getText().replaceAll("[^0-9]", ""));
    }
