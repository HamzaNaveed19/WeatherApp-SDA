...
private static HttpURLConnection fetchAPIResponse(String urlString){
    ...
    public static void main( String[] args )
    {
        ...
        // System.out.println(myApp.getComponentGasses());
        // Database.storeGasesComponent(locationName, myApp.getComponentGasses());
        System.out.println(myApp.getFiveDayForecast());
       //  Database.storeAQIComponent(locationName,myApp.getAQI());
       Database.storeFiveDayData(locationName, myApp.getFiveDayForecast());
    }
